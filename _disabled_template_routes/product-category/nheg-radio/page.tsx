...
export default function Page() {
  return (
    <div
      className="ffc-clone archive tax-product_cat term-nheg-radio term-46 wp-theme-jupiter theme-jupiter woocommerce woocommerce-page woocommerce-no-js wpb-js-composer js-comp-ver-8.7.3 vc_responsive"
      dangerouslySetInnerHTML={{ __html: loadCloneContent('product-category/nheg-radio') }}
    />
  )
}
