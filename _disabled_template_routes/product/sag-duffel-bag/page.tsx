...
export const metadata: Metadata = {
  ...pageMetadata({
    title: 'SAG Duffel Bag - New Heights Educational Group, Inc.',
    description:
    ...
    canonical: '/product/sag-duffel-bag/',
  }),
  title: { absolute: 'SAG Duffel Bag - New Heights Educational Group, Inc.' },
}

export default function Page() {
  return (
    <div
      className="ffc-clone wp-singular product-template-default single single-product postid-11963 wp-theme-jupiter theme-jupiter woocommerce woocommerce-page woocommerce-no-js wpb-js-composer js-comp-ver-8.7.3 vc_responsive"
      dangerouslySetInnerHTML={{ __html: loadCloneContent('product/sag-duffel-bag') }}
    />
  )
}
