...
export default function Page() {
  return (
    <div
      className="ffc-clone archive category category-education-news category-10 wp-theme-jupiter theme-jupiter woocommerce-no-js wpb-js-composer js-comp-ver-8.7.3 vc_responsive"
      dangerouslySetInnerHTML={{ __html: loadCloneContent('category/education-news') }}
    />
  )
}
