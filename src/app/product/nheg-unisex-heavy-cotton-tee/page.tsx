...
export const metadata: Metadata = {
  ...pageMetadata({
    title: 'NHEG Unisex Heavy Cotton Tee - New Heights Educational Group, Inc.',
    description:
    ...
    canonical: '/product/nheg-unisex-heavy-cotton-tee/',
  }),
  title: { absolute: 'NHEG Unisex Heavy Cotton Tee - New Heights Educational Group, Inc.' },
}

export default function Page() {
  return (
    <div
      className="ffc-clone wp-singular product-template-default single single-product postid-11450 wp-theme-jupiter theme-jupiter woocommerce woocommerce-page woocommerce-no-js wpb-js-composer js-comp-ver-8.7.3 vc_responsive"
      dangerouslySetInnerHTML={{ __html: loadCloneContent('product/nheg-unisex-heavy-cotton-tee') }}
    />
  )
}
