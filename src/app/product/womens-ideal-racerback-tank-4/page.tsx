...
export const metadata: Metadata = {
  ...pageMetadata({
    ...
    canonical: '/product/womens-ideal-racerback-tank-4/',
  }),
...
export default function Page() {
  return (
    <div
      className="ffc-clone wp-singular product-template-default single single-product postid-12387 wp-theme-jupiter theme-jupiter woocommerce woocommerce-page woocommerce-no-js wpb-js-composer js-comp-ver-8.7.3 vc_responsive"
      dangerouslySetInnerHTML={{ __html: loadCloneContent('product/womens-ideal-racerback-tank-4') }}
    />
  )
}
