...
export const metadata: Metadata = {
  ...
  title: { absolute: 'NHEG Unisex Heavy Blend™ Hooded Sweatshirt - New Heights Educational Group, Inc.' },
}
...
export default function Page() {
  return (
    <div
      ...
      dangerouslySetInnerHTML={{ __html: loadCloneContent('product/nheg-unisex-heavy-blend-hooded-sweatshirt') }}
    />
  )
}
