...
export const metadata: Metadata = {
  ...pageMetadata({
    title: 'NHEG Mousepad - New Heights Educational Group, Inc.',
    ...
    canonical: '/product/nheg-mousepad/',
  }),
  title: { absolute: 'NHEG Mousepad - New Heights Educational Group, Inc.' },
}

export default function Page() {
  return (
    <div
      className="ffc-clone wp-singular product-template-default single single-product postid-10561 wp-theme-jupiter theme-jupiter woocommerce woocommerce-page woocommerce-no-js wpb-js-composer js-comp-ver-8.7.3 vc_responsive"
      dangerouslySetInnerHTML={{ __html: loadCloneContent('product/nheg-mousepad') }}
    />
  )
}
