...
export const metadata: Metadata = {
  ...pageMetadata({
    title: 'AAG Unisex Hooded Zip Sweatshirt - New Heights Educational Group, Inc.',
    ...
    canonical: '/product/aag-unisex-hooded-zip-sweatshirt/',
  }),
  title: { absolute: 'AAG Unisex Hooded Zip Sweatshirt - New Heights Educational Group, Inc.' },
}

export default function Page() {
  return (
    <div
      className="ffc-clone wp-singular product-template-default single single-product postid-11785 wp-theme-jupiter theme-jupiter woocommerce woocommerce-page woocommerce-no-js wpb-js-composer js-comp-ver-8.7.3 vc_responsive"
      dangerouslySetInnerHTML={{ __html: loadCloneContent('product/aag-unisex-hooded-zip-sweatshirt') }}
    />
  )
}
