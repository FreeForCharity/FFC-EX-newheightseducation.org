...
export const metadata: Metadata = {
  ...pageMetadata({
    title: 'SLC Duffel Bag - New Heights Educational Group, Inc.',
    description:
    ...
    canonical: '/product/slc-duffel-bag/',
  }),
  title: { absolute: 'SLC Duffel Bag - New Heights Educational Group, Inc.' },
}

export default function Page() {
  return (
    <div
      className="ffc-clone wp-singular product-template-default single single-product postid-11955 wp-theme-jupiter theme-jupiter woocommerce woocommerce-page woocommerce-no-js wpb-js-composer js-comp-ver-8.7.3 vc_responsive"
      dangerouslySetInnerHTML={{ __html: loadCloneContent('product/slc-duffel-bag') }}
    />
  )
}
