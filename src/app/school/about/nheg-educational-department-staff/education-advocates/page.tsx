...
export default function Page() {
  return (
    <div
      className="ffc-clone wp-singular page-template-default page page-id-7768 page-child parent-pageid-222 wp-theme-jupiter wpb-js-composer js-comp-ver-7.7.2 vc_responsive"
      dangerouslySetInnerHTML={{ __html: loadCloneContent('school/about/nheg-educational-department-staff/education-advocates') }}
    />
  )
}
