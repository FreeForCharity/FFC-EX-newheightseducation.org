...
export default function Page() {
  return (
    <div
      className="ffc-clone wp-singular page-template-default page page-id-7314 page-child parent-pageid-476 wp-theme-jupiter wpb-js-composer js-comp-ver-7.7.2 vc_responsive"
      dangerouslySetInnerHTML={{ __html: loadCloneContent('school/parents/charter-school-families/charter-school-q-a') }}
    />
  )
}
