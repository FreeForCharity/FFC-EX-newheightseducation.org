...
export const metadata: Metadata = {
  ...pageMetadata({
    ...
    canonical: '/school/donor-dashboard/',
  }),
...
export default function Page() {
  return (
    <div
      className="ffc-clone wp-singular page-template-default page page-id-8377 wp-theme-jupiter wpb-js-composer js-comp-ver-7.7.2 vc_responsive"
      dangerouslySetInnerHTML={{ __html: loadCloneContent('school/donor-dashboard') }}
    />
  )
}
