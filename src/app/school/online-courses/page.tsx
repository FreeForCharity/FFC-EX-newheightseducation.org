...
export const metadata: Metadata = {
  ...pageMetadata({
    title: 'Courses - NHEG Online Learning Annex',
    ...
    canonical: '/school/online-courses/',
  }),
  title: { absolute: 'Courses - NHEG Online Learning Annex' },
}

export default function Page() {
  return (
    <div
      className="ffc-clone wp-singular page-template-default page page-id-2 page-parent wp-theme-jupiter wpb-js-composer js-comp-ver-7.7.2 vc_responsive"
      dangerouslySetInnerHTML={{ __html: loadCloneContent('school/online-courses') }}
    />
  )
}
