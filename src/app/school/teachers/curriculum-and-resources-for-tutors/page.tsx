...
export const metadata: Metadata = {
  ...
  title: {
    absolute: 'Protected: Curriculum and Resources for Tutors - NHEG Online Learning Annex',
  },
}
  ...
  return (
    <div
      ...
      dangerouslySetInnerHTML={{
        __html: loadCloneContent('school/teachers/curriculum-and-resources-for-tutors'),
      }}
    />
  )
}
