...
export const metadata: Metadata = {
  ...
  title: { absolute: 'Protected: Curriculum and Resources for Tutors - NHEG Online Learning Annex' },
}

export default function Page() {
  return (
    <div
      className="ffc-clone wp-singular page-template-default page page-id-3107 page-child parent-pageid-260 wp-theme-jupiter wpb-js-composer js-comp-ver-7.7.2 vc_responsive"
      dangerouslySetInnerHTML={{ __html: loadCloneContent('school/teachers/curriculum-and-resources-for-tutors') }}
    />
  )
}
