...
export const metadata: Metadata = {
  ...pageMetadata({
    title:
      'FEE Stories – Why College Degrees Are Losing Their Value - New Heights Educational Group, Inc.',
    description:
    ...
    <div
      ...
      dangerouslySetInnerHTML={{
        __html: loadCloneContent(
          'educational-articles/fee-stories-why-college-degrees-are-losing-their-value'
        ),
      }}
    />
  )
