...
export const metadata: Metadata = {
  ...
  title: {
    absolute: 'Attention drawn to high suicide rates in Scotland, Russia, Australia - NHEG',
  },
}
    ...
    <div
      ...
      dangerouslySetInnerHTML={{
        __html: loadCloneContent(
          'publications/attention-drawn-to-high-suicide-rates-in-scotland-russia-australia'
        ),
      }}
    />
  )
